<%@ Page Title="product" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Product4.aspx.cs" Inherits="WebApplication2.Product4" %>
    ...
    <div class="product-bg">
        <div class="product-bg-white">
            ...
            <div class="main-menu side-menu">
                ...
                <%if (NowPage == 1)
                    {%>
                <a href="Product4.aspx?pageIndex=<%=1 %>"><<</a>
                <% }
                  else
                    {%>
                <a href="Product4.aspx?pageIndex=<%=(NowPage-1) %>"><<</a>
                <% }%>
                <!-- 各頁 -->
                <%for (int i = 1; i <= PageCount; i++) 
                    {%> 
                <a href="Product4.aspx?pageIndex=<%=i %>"><%= i %></a>
                <% } %>
                <!-- 後一頁 -->
                <%if (NowPage == PageCount)
                    {%>
                <a href="Product4.aspx?pageIndex=<%=PageCount %>">>></a>
                <% }
                  else
                    {%>
                <a href="Product4.aspx?pageIndex=<%=(NowPage+1) %>">>></a>
