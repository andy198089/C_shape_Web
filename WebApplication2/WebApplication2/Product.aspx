            ...
            <div class="container">
                <div class="row">
                    <div ID="product_div1" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label1.Text.Split(' ')[0]%>'"> <!--給細項頁面產品資訊 -->
                            <i>
                    ...
                    <div ID="product_div2" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label2.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div3" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label3.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div4" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label4.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div5" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label5.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div6" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label6.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div7" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label7.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div8" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label8.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div9" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label9.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div10" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label10.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div11" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label11.Text.Split(' ')[0]%>'">
                            <i>
                    ...
                    <div ID="product_div12" class="col-xl-3 col-lg-3 col-md-6 col-sm-12" runat="server">
                        <div class="product-box select-area" onclick="location.href='Introduction_2.aspx?productclass=<%=PageClass%>&producttype=<%=Label12.Text.Split(' ')[0]%>'">
                            <i>
