<%@ Page Title="product" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Product7.aspx.cs" Inherits="WebApplication2.Product7" %>
    ...
    <div class="product-bg">
        <div class="product-bg-white">
            ...
            <div class="main-menu side-menu">
                ...
                <%if (NowPage == 1)
                    {%>
                <a href="Product7.aspx?pageIndex=<%=1 %>"><<</a>
                <% }
                  else
                    {%>
                <a href="Product7.aspx?pageIndex=<%=(NowPage-1) %>"><<</a>
                <% }%>
                <!-- 各頁 -->
                <%for (int i = 1; i <= PageCount; i++) 
                    {%> 
                <a href="Product7.aspx?pageIndex=<%=i %>"><%= i %></a>
                <% } %>
                <!-- 後一頁 -->
                <%if (NowPage == PageCount)
                    {%>
                <a href="Product7.aspx?pageIndex=<%=PageCount %>">>></a>
                <% }
                  else
                    {%>
                <a href="Product7.aspx?pageIndex=<%=(NowPage+1) %>">>></a>
